...
# TODO
#   make transforms a folder and define a helper in __init__ that takes
#   a transform (NodeTransformer class) and hooks it into the import flow.
#
#   ... with the end goal as enabling importing transforms at the top-level
#   a la from __future__ imports.
#
#   from dhaffner.transforms import ellipsis_partial
#
